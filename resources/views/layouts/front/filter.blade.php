	        		...
	        		<div class="row" id="mixitUp-item">
						<div class="col-md-3 col-sm-4 col-xs-6 mix presentation workshop">
							<div class="single-item">
								<img src="images/portfolio/riyadh.jpg" alt="">
								<div class="opacity tran3s">
									<div>
										<h6><a href="#">RIYADH</a></h6>
										<p>Saudi Arabia</p>
									</div>
								</div>
							</div>
