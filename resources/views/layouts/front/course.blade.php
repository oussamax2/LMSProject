						...
						<div class="col-md-4 col-xs-6 wow fadeInLeft">
							<div class="single-course">
								<div class="text">
									...
									<h5><a href="{{ url('/') }}/{{$sessionList->slug}}" class="tran3s">{{$sessionList->courses->title}}</a></h5>
									<ul class="clearfix">
										<li class="float-left">
										...
										<li class="float-right">
											...
											<a href="{{route('course')}}?cities={{isset($sessionList->cities)?$sessionList->cities->id:''}}" class="tran3s">{{$sessionList->countries->name}}, {{isset($sessionList->cities->name)?$sessionList->cities->name:''}}</a>
										</li>
									</ul>
								</div>
							</div>
