							...
							<div>
								...
								<div class="single-course clearfix">
									...
									<div class="text float-left">
										...
										<h5><a href="course-details.html" class="tran3s">Become a Master in UI/UX design within 1 Month.</a></h5>
								...
								<div class="single-course clearfix trending">
									...
									<div class="text float-left">
										...
										<h5><a href="course-details.html" class="tran3s">Create ResponsiveWordpress Theme with boootstrap.</a></h5>
