...
@section('og')
    ...
    <meta name="description" content="{!! \Illuminate\Support\Str::limit($sessions->courses->body, 170, $end='...') !!}">
    ...
    <meta property="og:description" content="{!! \Illuminate\Support\Str::limit($sessions->courses->body, 170, $end='...') !!}">
    ...
    <meta name="twitter:description" content="{!! \Illuminate\Support\Str::limit($sessions->courses->body, 170, $end='...') !!}">
